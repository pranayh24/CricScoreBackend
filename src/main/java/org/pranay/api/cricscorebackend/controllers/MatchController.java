...
//        }
//    }
    /*@GetMapping("/charts/wickets/{matchId}")
    public ResponseEntity<byte[]> getWicketsFallChart(@PathVariable String matchId) {
        return ResponseEntity.ok()
                .contentType(MediaType.IMAGE_PNG)
                .body(chartService.generateWicketsFallChart(matchId));
    }*/
